...
/** 
 * DAO for table "CHAPTER_COMMENT_LIST_ITEM_DATA_ITEM".
*/
public class ChapterCommentListItemDataItemDao extends AbstractDao<ChapterCommentListItemDataItem, Long> {

    public static final String TABLENAME = "CHAPTER_COMMENT_LIST_ITEM_DATA_ITEM";

    /**
     * Properties of entity ChapterCommentListItemDataItem.<br/>
    ...
    */
    ...
    public ChapterCommentListItemDataItemDao(DaoConfig config) {
        super(config);
    }
    
    public ChapterCommentListItemDataItemDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CHAPTER_COMMENT_LIST_ITEM_DATA_ITEM\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CHAPTER_COMMENT_LIST_ITEM_DATA_ITEM\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, ChapterCommentListItemDataItem entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public ChapterCommentListItemDataItem readEntity(Cursor cursor, int offset) {
        ChapterCommentListItemDataItem entity = new ChapterCommentListItemDataItem( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, ChapterCommentListItemDataItem entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(ChapterCommentListItemDataItem entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(ChapterCommentListItemDataItem entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
